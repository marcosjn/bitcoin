...
# Uma oferta é constituída por uma ou mais ordens, sendo assim, a quantidade da oferta
# é o resultado da soma das quantidades das ordens de mesmo preço unitário. 
# Caso uma oferta represente mais de uma ordem, a prioridade de execução 
# se dá com base na data de criação da ordem, da mais antiga para a mais nova.
